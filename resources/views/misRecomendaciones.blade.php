            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    @foreach($curso->clase as $clase)
                        <tr>
                            <td>{{$clase->nombre}}</td>
                            <td> <a href="{{route('aceptarrecomendacion', $clase->id)}}" class="btn btn-primary compartirBtn">Comprar</a>
                                <a href="{{route('rechazarrecomendacion', $clase->id)}}" class="btn btn-danger mr-1">Rechazar</a>
                            </td>
                        </tr>
